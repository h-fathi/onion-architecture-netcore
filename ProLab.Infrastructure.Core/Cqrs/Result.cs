...
namespace ProLab.Infrastructure.Core
{
    public class Result
    {
        private static readonly Result _ok = new Result(false, string.Empty, string.Empty);
        private readonly List<ValidationFailure> _failures;

        public static readonly Result None = new Result(false, string.Empty, string.Empty);
    ...
    public class Result<T> : Result
    {
        ...
        public static new readonly Result<T> None = new Result<T>(default, false, string.Empty, string.Empty);
