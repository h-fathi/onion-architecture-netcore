...
{
    /// <summary>
    /// A class that finds types needed by Befrosh by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Befrosh.
        /// </returns>
        ...
        /// <summary>Gets or sets whether Befrosh should iterate assemblies in the app domain when loading Befrosh types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Befrosh assemblies aren't investigated (e.g. by not including something like "^Befrosh|..." you may break core functionality.</remarks>
