...
namespace ProLab.Infrastructure.Core.Caching.Event
{
    /// <summary>
        ...
        where TEntity : BaseEntity
    {
        ...
        {
            await RemoveByPrefixAsync(CacheDefaults<TEntity>.ByIdsPrefix);
            await RemoveByPrefixAsync(CacheDefaults<TEntity>.AllPrefix);

            if (entityEventType != EntityEventType.Insert)
                await RemoveAsync(CacheDefaults<TEntity>.ByIdCacheKey, entity);
