...
namespace ProLab.Infrastructure.Core.Caching
{
    ...
    public abstract partial class CacheKeyService
    {
        ...
        /// <summary>
        /// Create a copy of cache key using the long cache time and fills it by passed parameters
        /// </summary>
        /// <param name="cacheKey">Initial cache key</param>
        /// <param name="cacheKeyParameters">Parameters to create cache key</param>
        /// <returns>Cache key</returns>
        public virtual CacheKey PrepareKeyForLongCache(CacheKey cacheKey, params object[] cacheKeyParameters)
        {
            var key = cacheKey.Create(CreateCacheKeyParameters, cacheKeyParameters);

            key.CacheTime = _cacheConfig.LongCacheTime;
        ...
        /// <param name="cacheKeyParameters">Parameters to create cache key</param>
        /// <returns>Cache key</returns>
        public virtual CacheKey PrepareKeyForLongCache(string _cacheKey, params object[] cacheKeyParameters)
        {
            var cacheKey = new CacheKey(_cacheKey);
            var key = cacheKey.Create(CreateCacheKeyParameters, cacheKeyParameters);
        ...
        /// <param name="cacheKeyParameters">Parameters to create cache key</param>
        /// <returns>Cache key</returns>
        public virtual CacheKey PrepareKeyForShortTermCache(string _cacheKey, params object[] cacheKeyParameters)
        {
            var cacheKey = new CacheKey(_cacheKey);
            var key = cacheKey.Create(CreateCacheKeyParameters, cacheKeyParameters);
        ...
        /// <param name="cacheKeyParameters">Parameters to create cache key</param>
        /// <returns>Cache key</returns>
        public virtual CacheKey PrepareKeyForDefaultCache(string _cacheKey, params object[] cacheKeyParameters)
        {
            var cacheKey = new CacheKey(_cacheKey);
            var key = cacheKey.Create(CreateCacheKeyParameters, cacheKeyParameters);
