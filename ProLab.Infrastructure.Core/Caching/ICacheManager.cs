...
namespace ProLab.Infrastructure.Core.Caching
{
    ...
    public interface ICacheManager : IDisposable
    {
        ...
        /// <param name="cacheKeyParameters">Parameters to create cache key</param>
        /// <returns>Cache key</returns>
        CacheKey PrepareKeyForLongCache(string _cacheKey, params object[] cacheKeyParameters);
        ...
        /// <param name="cacheKeyParameters">Parameters to create cache key</param>
        /// <returns>Cache key</returns>
        CacheKey PrepareKeyForDefaultCache(string _cacheKey, params object[] cacheKeyParameters);
        ...
        /// <param name="cacheKeyParameters">Parameters to create cache key</param>
        /// <returns>Cache key</returns>
        CacheKey PrepareKeyForShortTermCache(string _cacheKey, params object[] cacheKeyParameters);
        ...
        /// <param name="cacheKeyParameters">Parameters to create cache key</param>
        /// <returns>Cache key</returns>
        CacheKey PrepareKeyForLongCache(CacheKey cacheKey, params object[] cacheKeyParameters);
