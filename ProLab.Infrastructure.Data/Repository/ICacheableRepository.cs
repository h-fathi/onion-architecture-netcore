...
namespace ProLab.Infrastructure.Data
{
    ...
    public partial interface ICacheableRepository<TEntity> where TEntity : BaseEntity
    {
        #region Methods
        ...
        /// <param name="includeDeleted">Whether to include deleted items (applies only to <see cref="Core.ISoftDeletedEntity"/> entities)</param>
        /// <returns>
        /// A task that represents the asynchronous operation
        /// The task result contains the entity entry
        /// </returns>
        Task<TEntity> GetByIdAsync(int? id, Func<ICacheManager, CacheKey> getCacheKey = null, bool includeDeleted = true);
        ...
        /// </returns>
        Task<IList<TEntity>> GetByIdsAsync(IList<int> ids, Func<ICacheManager, CacheKey> getCacheKey = null, bool includeDeleted = true);
        ...
        Task<IList<TEntity>> GetAllAsync(Func<IQueryable<TEntity>, Task<IQueryable<TEntity>>> func,
            Func<ICacheManager, Task<CacheKey>> getCacheKey, bool includeDeleted = true);
